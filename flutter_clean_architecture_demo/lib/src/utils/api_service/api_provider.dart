...
import 'package:flutter_clean_architecture_demo/src/utils/global_variables.dart';
import 'package:flutter_clean_architecture_demo/src/utils/navigator_key.dart';
...
class APIManager {
  ...
  APIManager._internal() {
    ...
    (dio.httpClientAdapter as IOHttpClientAdapter).createHttpClient = () {
      ...
      ///with a server certificate that cannot be authenticated
  ...
  dynamic _handleError(BuildContext context, DioException error) {
    ...
    if (error.type == DioExceptionType.badResponse && error.response != null) {
      ...
      /// Invalid Authentication : Need to redirect login screen
      if (error.response!.data == null) {
        const message = ValidationString.validationInternalServerIssue;
        if (CommonFunction.isDialogShowing) {
          Navigator.of(context).pop();
        }
        CommonFunction.isDialogShowing = true;
